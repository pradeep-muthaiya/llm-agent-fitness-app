...
def parse_ai_message_to_openai_tool_action_two(
    message: BaseMessage,
...
class OpenAIToolsAgentOutputParserTwo(MultiActionAgentOutputParser):
    ...
    def parse_result(
        ...
        return parse_ai_message_to_openai_tool_action_two(message)
